...
namespace GameAssetsStore.Data.Migrations
{
    ...
    [Migration("20230703112610_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GameAssetsStore.Data.Models.Seller", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("OwningUserId")
                        .HasColumnType("uniqueidentifier")
                        .HasComment("User owning the seller profile.");
            ...
            modelBuilder.Entity("GameAssetsStore.Data.Models.Asset", b =>
                {
                    b.HasOne("GameAssetsStore.Data.Models.Seller", "Seller")
                        .WithMany("SellerAssets")
            ...
            modelBuilder.Entity("GameAssetsStore.Data.Models.Review", b =>
                {
                    b.HasOne("GameAssetsStore.Data.Models.ApplicationUser", "ReviewCreator")
                        .WithMany("Reviews")
            ...
            modelBuilder.Entity("GameAssetsStore.Data.Models.Seller", b =>
                {
                    b.HasOne("GameAssetsStore.Data.Models.ApplicationUser", "OwningUser")
                        .WithOne("OwnedSellerProfile")
                        .HasForeignKey("GameAssetsStore.Data.Models.Seller", "OwningUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("GameAssetsStore.Data.Models.ApplicationUser", b =>
                {
                    b.Navigation("OwnedSellerProfile");
