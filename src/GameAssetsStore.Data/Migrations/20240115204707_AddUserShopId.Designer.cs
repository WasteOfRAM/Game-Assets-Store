...
namespace GameAssetsStore.Data.Migrations
{
    ...
    [Migration("20240115204707_AddUserShopId")]
    partial class AddUserShopId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GameAssetsStore.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<Guid?>("OwnedShopId")
                        .HasColumnType("uniqueidentifier")
                        .HasComment("Shop profile if created");
            ...
            modelBuilder.Entity("GameAssetsStore.Data.Models.PaymentMethod", b =>
                {
                    ...
                    b.ToTable("PaymentMethods", t =>
                        {
                            t.HasComment("A fake payment method fo testing");
                        });
